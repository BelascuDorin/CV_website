    ...
    >
      <div className="max-w-4xl mx-auto px-6 sm:px-8 py-16 sm:py-24">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-10 sm:gap-14">
          {/* Headshot */}
          <div className="relative w-36 h-36 sm:w-44 sm:h-44 rounded-full overflow-hidden shrink-0 ring-4 ring-teal-100 shadow-lg">
            <Image
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="mt-2 text-lg font-semibold text-teal-600">{data.role}</p>
            ...
            <div className="mt-7 flex flex-wrap justify-center sm:justify-start gap-3 text-sm font-medium">
              <a
                ...
                className="px-4 py-2 rounded-full bg-teal-600 text-white hover:bg-teal-700 transition-colors"
              >
                Email me
              </a>
              <a
                ...
                className="px-4 py-2 rounded-full border border-gray-200 text-gray-700 hover:border-teal-300 hover:text-teal-700 transition-colors"
              >
                LinkedIn
              </a>
              <a
