...
**Experience**:
The chronological record of past and present professional roles. Sourced from the CV/LinkedIn. Distinct from the Now Section in that it covers the full history, not just active roles.
...
**Proof Card**:
The UI element that displays a Skill Proof. Opened via the Skills section (carousel or expandable interaction). Contains: the Skill name, the claim, the outcome, and the URL.
_Avoid_: Modal, popup, detail view
